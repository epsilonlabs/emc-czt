...
\begin{zed}RAddBirthday == ( AddBirthday \land Success ) \lor AlreadyKnown
\end{zed}\begin{zed}RFindBirthday == ( FindBirthday \land Success ) \lor NotKnown
\end{zed}\begin{zed}RRemind == Remind \land Success
\end{zed}
